...
<p>Las credenciales fueron enviadas a tu TV.<br>Ya puedes cerrar esta página.</p>
  ...
  Widget build(BuildContext context) {
    ...
    // viewInsets.bottom = height of keyboard when open
    final keyboardH = MediaQuery.of(context).viewInsets.bottom;

    return Scaffold(
      backgroundColor: const Color(0xFF060C1B),
      // Let Scaffold resize so SingleChildScrollView can scroll above keyboard
                ...
                child: Form(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    _field(ctrl: _userCtrl, focus: _userFocus, next: _passFocus,
                      label: 'Usuario', icon: Icons.person_rounded, autofocus: false,
