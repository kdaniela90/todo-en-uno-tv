...
class _SettingsSheetState extends State<_SettingsSheet> {
  ...
  void _loadTracks() {
    // Intenta leer pistas disponibles; falla silenciosamente si el API no existe
    try {
      ...
      // video_player version doesn't support track listing — show empty state
    }
  }
        ...
        if (!hasContent)
          ...
          if (_audioTracks.isNotEmpty) ...[
            ...
            ..._audioTracks.map((t) => _TrackTile(
              track: t, isSelected: _selAudio == t.index,
          ...
          if (_subTracks.isNotEmpty) ...[
            ...
            _TrackTile(
              track: _TrackInfo(-1, 'Ninguno', ''),
              isSelected: _selSub == -1, color: AppColors.azul,
              onTap: () => _selectSub(-1)),
            ..._subTracks.map((t) => _TrackTile(
              track: t, isSelected: _selSub == t.index,
...
class _TrackTile extends StatelessWidget {
  final _TrackInfo track;
  final bool isSelected;
  final Color color;
  final VoidCallback onTap;
  const _TrackTile({required this.track, required this.isSelected,
